...
local Window = Library.CreateLib("Drain HUB", "RJTheme3")

local Tab = Window:NewTab("The дурка")

local Section = Tab:NewSection("Money")


Section:NewButton("Много денег ЛОКАЛЬНО!", "Дает вам много денег локально", function()
    local durkoBucks = 995993699919654
local player = game.Players.LocalPlayer

if player and player:FindFirstChild("leaderstats") then
    local durkoBucksValue = player.leaderstats:FindFirstChild("ДуркоБаксы")
    if durkoBucksValue then
        durkoBucksValue.Value = durkoBucks
    end
end
end)

Section:NewSlider("Деньги", "Выдаст вам столько денег сколько вы укажите", 9999999999999999, 0, function(MoneyCustom) -- 9999999999999999 (Макс. значение) | 0 (Мин. значение)
    local durkoBucks = MoneyCustom
local player = game.Players.LocalPlayer
...
local Section = Tab:NewSection("Esp/другое")


Section:NewButton("FPS BOOSER", "Вырежит пару моделей и добавить + 30-40 fps", function()
...
Section:NewButton("Esp", "Дает вам подсветку каждого игрока сквоз стены", function()
...
Section:NewButton("Fullbright", "Ночью будет светло как днем", function()
...
Section:NewButton("Infinite Jump", "Бесконечные прыжки", function()
...
Section:NewSlider("Высота прыжка", "Меняет высоту вашего прыжка", 500, 0, function(s) -- 500 (Макс. значение) | 0 (Мин. значение)
...
Section:NewButton("Anti AFK", "Сделает что бы вас не смогли кикнуть во время афк", function()
    wait(0.5)
...
game:service'Players'.LocalPlayer.Idled:connect(function()
    ...
    AfkStatus.Text = "Роблокс попыталься вас кикнуть."
    wait(2)
    AfkStatus.Text = "Анти афк включено"
end)
end)


Section:NewButton("Infinite Yield Reborn v6.3.7", "Заинжектит вам Infinite Yield Reborn v6.3.7", function()
...
Section:NewButton("Speed Gui", "Дасть вам любую скорость которую укажите", function()
...
credits.Text = "Пиши какую скорость надо (17 советую не детектит)"
...
Section:NewButton("Air Hub (Aimbot Hub)", "Заинжектит самый лучший в мире аимбот скрипт", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/AirHub/main/AirHub.lua"))()
end)

local Section = Tab:NewSection("Money Farm")
...
titleLabel.Text = "Я ИГРАЮ С Drain HUB"
titleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
titleLabel.TextScaled = true
titleLabel.Parent = frame

discordButton.Size = UDim2.new(0.5, 0, 0.3, 0)
discordButton.Position = UDim2.new(0.25, 0, 0.5, 0)
...
closeButton.Size = UDim2.new(0.1, 0, 0.1, 0) -- Размер кнопки
closeButton.Position = UDim2.new(1, -30, 0, 5) -- Положение в правом верхнем углу
closeButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- Цвет кнопки
...
discordButton.MouseButton1Click:Connect(function()
    setclipboard("https://discord.gg/FfQ3uVMsDQ")
